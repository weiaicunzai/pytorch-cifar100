...
#
#vis.images(
#    np.random.rand(3, 200, 200),
#    opts=dict(title='Random!', caption='How random.uuuuuuuuu'))
...
#Projects 0
#Insights
#visdom/example/demo.py
#5a585f1 on May 12
#@cympfh cympfh textlabels bugs in scatter?
#@lvdmaaten
#@JackUrb
#@zuoxingdong
#@wkentaro
